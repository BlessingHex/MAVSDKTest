...
execute_process(
  COMMAND "/usr/bin/git" show-ref "42e892d96e47b1f6e29844cc705e148ec4856448"
  WORKING_DIRECTORY "/home/blessing/MAVSDKTEST/test-app/third_party/jsoncpp/jsoncpp/src/jsoncpp"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "42e892d96e47b1f6e29844cc705e148ec4856448")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("42e892d96e47b1f6e29844cc705e148ec4856448" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/42e892d96e47b1f6e29844cc705e148ec4856448")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/blessing/MAVSDKTEST/test-app/third_party/jsoncpp/jsoncpp/src/jsoncpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/blessing/MAVSDKTEST/test-app/third_party/jsoncpp/jsoncpp/src/jsoncpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
