...
execute_process(
  COMMAND "/usr/bin/git" show-ref "9.0.0"
  WORKING_DIRECTORY "/home/blessing/MAVSDKTEST/test-app/third_party/tinyxml2/tinyxml2/src/tinyxml2"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/blessing/MAVSDKTEST/test-app/third_party/tinyxml2/tinyxml2/src/tinyxml2'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/blessing/MAVSDKTEST/test-app/third_party/tinyxml2/tinyxml2/src/tinyxml2'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
