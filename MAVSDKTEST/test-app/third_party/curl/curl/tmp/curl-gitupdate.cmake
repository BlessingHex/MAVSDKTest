...
execute_process(
  COMMAND "/usr/bin/git" show-ref "curl-7_83_1"
  WORKING_DIRECTORY "/home/blessing/MAVSDKTEST/test-app/third_party/curl/curl/src/curl"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("curl-7_83_1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/curl-7_83_1")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/blessing/MAVSDKTEST/test-app/third_party/curl/curl/src/curl'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/blessing/MAVSDKTEST/test-app/third_party/curl/curl/src/curl'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
